...
constexpr inline bool isSquareAttacked(Square square, Colour side) {
...
constexpr inline void addMove(moves &moveList, int move) {
// store move
  moveList.emplace_back(move);
}

// make move on chess board
constexpr inline int makeMove(int move, int moveFlag) {
  // quiet moves
...
// generate all moves
constexpr inline void generateMoves(moves &moveList) {
  moveList.clear();
